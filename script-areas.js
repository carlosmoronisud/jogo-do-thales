...
const elementoScoreArea = document.getElementById("score-area");

if (!formaImagem || !perguntaArea || !alternativasArea || !resultadoArea || !elementoScoreArea) {
    ...
    function verificarRespostaArea(respostaSelecionada, respostaCorreta) {
        ...
        if (parseFloat(respostaSelecionada) === parseFloat(respostaCorreta)) {
            ...
            elementoScoreArea.textContent = score; // Atualiza o valor na tela
            elementoScoreArea.style.color = "green";
        } else {
            ...
            elementoScoreArea.textContent = score; // Atualiza o valor na tela
            elementoScoreArea.style.color = "red";
        }
